...
public class BelleStringhe {
    ...
    private static final List<String> coolNames = Arrays.asList("Giorgio", "Golemmo", "Gormita", "Giangiotto", "Argillo", "Argillino", "Sparkly", "Margot", "Hottie", "Shocky", "Asdrubale", "Kali", "Kibly", "Lucky", "Rick_Astley","Jagiellon");
